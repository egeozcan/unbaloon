...
// The four vehicle spawn buttons (helicopter, plane, bulldozer, tractor) form one
...
// unreachable. Centralised here so all four managers stay in lockstep.

export const VEHICLE_BUTTON_COUNT = 4;
