...
// ── Jeep (direct-control bumper toy) ─────────────────────────────────────────
export const JEEP_LIFETIME = 30;
export const JEEP_COOLDOWN = 32;
export const JEEP_FADE_DURATION = 1.2;
export const JEEP_SIZE_RATIO = 0.15;
export const JEEP_MIN_SIZE = 82;
export const JEEP_SPEED = 115;
export const JEEP_GROUND_LOCAL = 0.38;
export const JEEP_BODY_HALF_RATIO = 0.50;
export const JEEP_BUMPER_DX = 0.56;
export const JEEP_BUMPER_HEIGHT_RATIO = 0.33;
export const JEEP_BONK_NUDGE = 18;
export const JEEP_BODY_COLOR = '#2F8F83';
export const JEEP_BODY_DARK = '#17675F';
export const JEEP_SEAT_COLOR = '#F3C969';
export const JEEP_WINDOW_COLOR = '#BFE3FF';
export const JEEP_WHEEL_COLOR = '#2A2F38';
export const JEEP_WHEEL_HUB = '#FF8F5A';
export const JEEP_DETAIL_COLOR = '#24343A';

// ── Backhoe (front scoop + rear bucket relay) ────────────────────────────────
export const BACKHOE_LIFETIME = 30;
export const BACKHOE_COOLDOWN = 35;
export const BACKHOE_FADE_DURATION = 1.2;
export const BACKHOE_SIZE_RATIO = 0.18;
export const BACKHOE_MIN_SIZE = 96;
export const BACKHOE_DRIVE_SPEED = 190;
export const BACKHOE_GROUND_LOCAL = 0.40;
export const BACKHOE_BODY_HALF_RATIO = 0.52;
export const BACKHOE_SCOOP_UP = 0.44;
export const BACKHOE_REACH_V_RATIO = 0.75;
export const BACKHOE_ARM_SPEED = 700;
export const BACKHOE_BOOM_RATIO = 0.88;
export const BACKHOE_STICK_RATIO = 0.72;
...
export const WHEELED_EXCAVATOR_COOLDOWN = 36;
export const WHEELED_EXCAVATOR_FADE_DURATION = 1.2;
export const WHEELED_EXCAVATOR_SIZE_RATIO = 0.18;
export const WHEELED_EXCAVATOR_MIN_SIZE = 96;
export const WHEELED_EXCAVATOR_DRIVE_SPEED = 210;
export const WHEELED_EXCAVATOR_GROUND_LOCAL = 0.41;
export const WHEELED_EXCAVATOR_BODY_HALF_RATIO = 0.50;
export const WHEELED_EXCAVATOR_BOOM_RATIO = 1.12;
export const WHEELED_EXCAVATOR_STICK_RATIO = 0.92;
export const WHEELED_EXCAVATOR_REACH_MARGIN = 0.94;
export const WHEELED_EXCAVATOR_ARM_SPEED = 760;
export const WHEELED_EXCAVATOR_GRAB_DIST = 30;
export const WHEELED_EXCAVATOR_SWING_SPEED = 2.8;
export const WHEELED_EXCAVATOR_SWING_ARC = Math.PI * 0.8;
export const WHEELED_EXCAVATOR_HIT_CAP = 3;
export const WHEELED_EXCAVATOR_BODY_COLOR = '#18A6A1';
export const WHEELED_EXCAVATOR_BODY_DARK = '#0C716F';
export const WHEELED_EXCAVATOR_CAB_COLOR = '#39C4BC';
export const WHEELED_EXCAVATOR_WINDOW_COLOR = '#D8F4FF';
export const WHEELED_EXCAVATOR_ARM_COLOR = '#F2A93B';
export const WHEELED_EXCAVATOR_ARM_DARK = '#AF6D17';
...
export const PURPLE_PLANE_COOLDOWN = 35;
export const PURPLE_PLANE_FADE_DURATION = 1.2;
export const PURPLE_PLANE_SIZE_RATIO = 0.17;
export const PURPLE_PLANE_MIN_SIZE = 68;
export const PURPLE_PLANE_SPEED = 300;
export const PURPLE_PLANE_TURN_RATE = 3.1;
export const PURPLE_PLANE_PROP_SPEED = 39;
export const PURPLE_PLANE_OVERSHOOT_RATIO = 0.28;
export const PURPLE_PLANE_ARRIVE_RADIUS = 46;
export const PURPLE_PLANE_TRAIL_LIFETIME = 2.2;
export const PURPLE_PLANE_TRAIL_SPACING = 14;
export const PURPLE_PLANE_MARK_RADIUS = 42;
export const PURPLE_PLANE_MARK_CAP = 4;
export const PURPLE_PLANE_BODY_COLOR = '#7B4CC9';
export const PURPLE_PLANE_WING_COLOR = '#56339A';
export const PURPLE_PLANE_WINDOW_COLOR = '#D8F4FF';
export const PURPLE_PLANE_ACCENT_COLOR = '#F2C94C';
export const PURPLE_PLANE_PROP_COLOR = '#2A2F38';
export const PURPLE_PLANE_TRAIL_COLOR = '#C9A7FF';
